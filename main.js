...
Logical Reasoning: ${cLR * 3 - incLR} / 60          | Mathematics: ${cMath * 3 - incMath} / 90
Total Attempted: ${incLR + cLR} / 20              | Total Attempted: ${incMath + cMath} / 30
Total Correct: ${cLR}                           | Total Correct: ${cMath}
Total Incorrect: ${incLR}                       | Total Incorrect: ${incMath}
Total Unattempted: ${20 - incLR - cLR}              | Total Unattempted: ${30 - incMath - cMath}
